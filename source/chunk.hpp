...
typedef enum
{
  ...
  OP_REDUCE_BEGIN,
  OP_REDUCE_UPDATE,
  OP_PARALLEL_FOR_BEGIN,
  OP_PARALLEL_FOR_END,
  OP_EXIT_IF_FALSE_ITERATOR,
  OP_REDUCE_PARALLEL_INITIALISE,
  OP_PARALLEL_REDUCE_BEGIN,
  OP_REDUCE_PARALLEL_INCREMENT,
  OP_UPDATE_PARALLEL_REDUCE
} OpCode;
