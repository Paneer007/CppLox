...
hidden if the `CppLox_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `CppLox_DEVELOPER_MODE` to the configure
...
Runs the executable target `CppLox_exe`.
